...
```bash
go test -v --bench github.com/libonomy/cusp-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/libonomy/cusp-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/libonomy/cusp-sdk/crypto/keys/mintkey	12.093s
```
