...
func TestPublicKeyUnsafe(t *testing.T) {
	...
	require.Equal(t, "libonomypub1addwnpepqd87l8xhcnrrtzxnkql7k55ph8fr9jarf4hn6udwukfprlalu8lgw0urza0",
		pubKeyAddr, "Is your device using test mnemonic: %s ?", tests.TestMnemonic)

	addr := sdk.AccAddress(priv.PubKey().Address()).String()
	require.Equal(t, "libonomy1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		addr, "Is your device using test mnemonic: %s ?", tests.TestMnemonic)
}

func TestPublicKeyUnsafeHDPath(t *testing.T) {
	expectedAnswers := []string{
		"libonomypub1addwnpepqd87l8xhcnrrtzxnkql7k55ph8fr9jarf4hn6udwukfprlalu8lgw0urza0",
		"libonomypub1addwnpepqfsdqjr68h7wjg5wacksmqaypasnra232fkgu5sxdlnlu8j22ztxvlqvd65",
		"libonomypub1addwnpepqw3xwqun6q43vtgw6p4qspq7srvxhcmvq4jrx5j5ma6xy3r7k6dtxmrkh3d",
		"libonomypub1addwnpepqvez9lrp09g8w7gkv42y4yr5p6826cu28ydrhrujv862yf4njmqyyjr4pjs",
		"libonomypub1addwnpepq06hw3enfrtmq8n67teytcmtnrgcr0yntmyt25kdukfjkerdc7lqg32rcz7",
		"libonomypub1addwnpepqg3trf2gd0s2940nckrxherwqhgmm6xd5h4pcnrh4x7y35h6yafmcpk5qns",
		"libonomypub1addwnpepqdm6rjpx6wsref8wjn7ym6ntejet430j4szpngfgc20caz83lu545vuv8hp",
		"libonomypub1addwnpepqvdhtjzy2wf44dm03jxsketxc07vzqwvt3vawqqtljgsr9s7jvydjmt66ew",
		"libonomypub1addwnpepqwystfpyxwcava7v3t7ndps5xzu6s553wxcxzmmnxevlzvwrlqpzz695nw9",
		"libonomypub1addwnpepqw970u6gjqkccg9u3rfj99857wupj2z9fqfzy2w7e5dd7xn7kzzgkgqch0r",
	}
...
func TestPublicKeySafe(t *testing.T) {
	path := *hd.NewFundraiserParams(0, sdk.CoinType, 0)
	priv, addr, err := NewPrivKeyLedgerSecp256k1(path, "libonomy")
...
func TestPublicKeyHDPath(t *testing.T) {
	...
	expectedAddrs := []string{
		"libonomy1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		"libonomy19ewxwemt6uahejvwf44u7dh6tq859tkyvarh2q",
		"libonomy1a07dzdjgjsntxpp75zg7cgatgq0udh3pcdcxm3",
		"libonomy1qvw52lmn9gpvem8welghrkc52m3zczyhlqjsl7",
		"libonomy17m78ka80fqkkw2c4ww0v4xm5nsu2drgrlm8mn2",
		"libonomy1ferh9ll9c452d2p8k2v7heq084guygkn43up9e",
		"libonomy10vf3sxmjg96rqq36axcphzfsl74dsntuehjlw5",
		"libonomy1cq83av8cmnar79h0rg7duh9gnr7wkh228a7fxg",
		"libonomy1dszhfrt226jy5rsre7e48vw9tgwe90uerfyefa",
		"libonomy1734d7qsylzrdt05muhqqtpd90j8mp4y6rzch8l",
	}
...
func getFakeTx(accountNumber uint32) []byte {
	tmp := fmt.Sprintf(
		`{"account_number":"%d","chain_id":"1234","fee":{"amount":[{"amount":"150","denom":"libocoin"}],"gas":"5000"},"memo":"memo","msgs":[[""]],"sequence":"6"}`,
		accountNumber)
