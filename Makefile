...
test_ledger_mock:
	@go test -mod=readonly `go list github.com/evdatsion/cosmos-sdk/crypto` -tags='cgo ledger test_ledger_mock'

test_ledger: test_ledger_mock
	@go test -mod=readonly -v `go list github.com/evdatsion/cosmos-sdk/crypto` -tags='cgo ledger'
