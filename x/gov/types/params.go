...
import (
	...
	params "github.com/libonomy/cusp-sdk/x/params/subspace"
)
...
type DepositParams struct {
	...
	MaxDepositPeriod time.Duration `json:"max_deposit_period,omitempty" yaml:"max_deposit_period,omitempty"` //  Maximum period for Libocoin holders to deposit on a proposal. Initial value: 2 months
}
...
type TallyParams struct {
	Quorum    sdk.Dec `json:"quorum,omitempty" yaml:"quorum,omitempty"`       //  Minimum percentage of total libocoin needed to vote for a result to be considered valid
