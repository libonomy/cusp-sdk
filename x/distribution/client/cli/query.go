...
import (
	...
	"github.com/libonomy/cusp-sdk/x/distribution/client/common"
...
Example:
$ %s query distr validator-outstanding-rewards libonomyvaloper1lwjmdnks33xwnmfayc64ycprww49n33mtm92ne
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission libonomyvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes libonomyvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards libonomy1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p
$ %s query distr rewards libonomy1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p libonomyvaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj
`,
