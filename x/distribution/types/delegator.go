...
type DelegatorStartingInfo struct {
	...
	Stake          sdk.Dec `json:"lby" yaml:"lby"`                     // amount of staking token delegated
	Height         uint64  `json:"creation_height" yaml:"creation_height"` // height at which delegation was created
}

// create a new DelegatorStartingInfo
func NewDelegatorStartingInfo(previousPeriod uint64, lby sdk.Dec, height uint64) DelegatorStartingInfo {
