...
import (
	...
	types "github.com/libonomy/cusp-sdk/x/staking/types"
)

// Slash a validator for an infraction committed at a known height
// Find the contributing flby at that height and burn the specified slashFactor
...
func (k Keeper) Slash(ctx sdk.Context, consAddr sdk.ConsAddress, infractionHeight int64, power int64, slashFactor sdk.Dec) {
	...
	// ref https://github.com/libonomy/cusp-sdk/issues/1348
	...
	// redelegations, as that flby has since unbonded
	...
	// TODO Return event(s), blocked on https://github.com/libonomy/aphelion-staking/pull/1803
	return
}
...
// the unbonding delegation had enough flby to slash
// (the amount actually slashed may be less if there's
// insufficient flby remaining)
func (k Keeper) slashUnbondingDelegation(ctx sdk.Context, unbondingDelegation types.UnbondingDelegation,
	...
	for i, entry := range unbondingDelegation.Entries {
		...
		// If unbonding started before this height, flby didn't contribute to infraction
		...
		// Calculate slash amount proportional to flby contributing to infraction
		...
		// according to flby held at time of infraction
...
func (k Keeper) slashRedelegation(ctx sdk.Context, srcValidator types.Validator, redelegation types.Redelegation,
	...
	for _, entry := range redelegation.Entries {
		...
		// If redelegation started before this height, flby didn't contribute to infraction
		if entry.CreationHeight < infractionHeight {
			continue
		}
