...
func TestSlashUnbondingDelegation(t *testing.T) {
	...
	// test valid slash, before expiration timestamp and to which flby contributed
...
func TestSlashRedelegation(t *testing.T) {
	...
	// started redelegating prior to the current height, flby didn't contribute to infraction
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	validator, found = keeper.GetValidatorByConsAddr(ctx, consAddr)
	require.True(t, found)
	// power decreased by 3 - 6 flby originally bonded at the time of infraction
	// was still bonded at the time of discovery and was slashed by half, 4 flby
	...
	// slash validator again
	// all originally bonded flby has been slashed, so this will have no effect
	// on the unbonding delegation, but it will slash flby bonded since the infraction
	...
	// read updated validator
	// power decreased by 1 again, validator is out of flby
...
func TestSlashWithRedelegation(t *testing.T) {
	...
	validator, found = keeper.GetValidatorByConsAddr(ctx, consAddr)
	require.True(t, found)
	// power decreased by 2 - 4 flby originally bonded at the time of infraction
	// was still bonded at the time of discovery and was slashed by half, 4 flby
	// bonded at the time of discovery hadn't been bonded at the time of infraction
	// and wasn't slashed
...
func TestSlashBoth(t *testing.T) {
	...
	validator, found = keeper.GetValidatorByConsAddr(ctx, sdk.GetConsAddress(PKs[0]))
	require.True(t, found)
	// power not decreased, all flby was bonded since
