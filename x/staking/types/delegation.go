...
type UnbondingDelegationEntry struct {
	...
	InitialBalance sdk.Int   `json:"initial_balance" yaml:"initial_balance"` // libocoins initially scheduled to receive at completion
	Balance        sdk.Int   `json:"balance" yaml:"balance"`                 // libocoins to receive at completion
}
