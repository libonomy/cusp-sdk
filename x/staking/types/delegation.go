...
type UnbondingDelegationEntry struct {
	...
	InitialBalance sdk.Int   `json:"initial_balance" yaml:"initial_balance"` // lbys initially scheduled to receive at completion
	Balance        sdk.Int   `json:"balance" yaml:"balance"`                 // lbys to receive at completion
}
