...
func TestGenesisAccountValidate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			NewGenesisAccountRaw(addr, sdk.NewCoins(sdk.NewInt64Coin("flby", 50)),
				sdk.NewCoins(sdk.NewInt64Coin("flby", 100)), 0, 0, "", ""),
		...
		},
		{
			...
			NewGenesisAccountRaw(addr,
				sdk.NewCoins(sdk.NewInt64Coin("flby", 50), sdk.NewInt64Coin("eth", 50)),
				sdk.NewCoins(sdk.NewInt64Coin("flby", 100), sdk.NewInt64Coin("eth", 20)),
				0, 0, "", ""),
			errors.New("vesting amount cannot be greater than total amount"),
		},
		{
			...
			NewGenesisAccountRaw(addr, sdk.NewCoins(sdk.NewInt64Coin("flby", 50)),
				sdk.NewCoins(sdk.NewInt64Coin("flby", 50)), 1654668078, 1554668078, "", ""),
