...
func TestVestingAccountSend(t *testing.T) {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin("libocoin", 100))
	sendCoins := sdk.NewCoins(sdk.NewInt64Coin("libocoin", 50))
...
func TestDelegateCoins(t *testing.T) {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin("libocoin", 100))
	delCoins := sdk.NewCoins(sdk.NewInt64Coin("libocoin", 50))
