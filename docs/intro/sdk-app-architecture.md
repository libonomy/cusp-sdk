...
Tendermint passes transactions from the network to the application through an interface called the [ABCI](https://github.com/evdatsion/tendermint/tree/master/abci), which the application must implement. 
